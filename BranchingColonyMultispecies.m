...
strainName = {'WT','Cheater','Hyperswarmer'};
% index 1 = WT
% index 2 = Cheater
% index 3 = Hyperswarmer
initialFract = [1, 0, 0];
initialFract = initialFract / sum(initialFract);

aCs = [1, 1.2, 1] * 1.5/2; % cell growth rate
gammas = 12 * [1, 0, 1.2]*2; % expansion efficiency
...
% branch density & width of single-strain colonies
